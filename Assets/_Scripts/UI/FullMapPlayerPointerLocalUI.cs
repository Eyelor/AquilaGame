...
public class FullMapPlayerPointerLocalUI : MonoBehaviour
{
    ...
    private void Update()
    {
        playerPointerTransform.localPosition = new Vector3(
            (playerTransform.position.x - half) / scale,
            (playerTransform.position.z - half) / scale
        );
