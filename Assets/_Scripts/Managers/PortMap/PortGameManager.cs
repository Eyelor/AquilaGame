...
public class PortGameManager : Singleton<PortGameManager>
{
    ...
    protected override void OnDestroy()
    {
        ...
        {
            GameInputSystem.Instance.OnFullMapAction -= GameInputSystem_OnFullMapAction;
            Debug.Log($"[PortGameManager] OnFullMapAction has {GameInputSystem.Instance.GetOnFullMapActionSubscribersCount()} subscribers after OnDestroy.");
        }
